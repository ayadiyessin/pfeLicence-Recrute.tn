...
exports.create = (req, res) => {
    ...
    const admin = new Admin({
        PHOTO_ADM: req.body.PHOTO_ADM,
        EMAIL_ADM: req.body.EMAIL_ADM,
        PSW_ADM: req.body.PSW_ADM,
        NOM_ADM: req.body.NOM_ADM,
        PRE_ADM: req.body.PRE_ADM,
        SEXE_ADM: req.body.SEXE_ADM,
        VILLE_ADM: req.body.VILLE_ADM,
        NUM_TEL_ADM: req.body.NUM_TEL_ADM,
        ARCHIV_ADM: req.body.ARCHIV_ADM,
        ETAT_ADM: req.body.ETAT_ADM
    });
